      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col md:flex-row font-sans">
        ...
        <aside className="w-full md:w-72 bg-white dark:bg-gray-900 border-r dark:border-gray-800 flex flex-col shadow-sm z-10 relative">
          ...
          <nav className="flex-1 px-4 py-6 space-y-2">
            ...
            <SidebarLink to="/conversations" icon={MessageSquare}>{t('conversations')}</SidebarLink>
            <SidebarLink to="/orders" icon={ShoppingCart}>{t('orders')}</SidebarLink>
          </nav>

          <div className="p-6 border-t dark:border-gray-800 mt-auto space-y-4">
             <div className="flex items-center gap-3 p-3 text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800 rounded-lg cursor-pointer transition-colors">
               <Settings size={20} />
